...
{
    public partial class InformePacientesPorFecha : System.Web.UI.Page
    {
        /*Page_Load
        ...
        y sean correctas, luego genera el informe de pacientes por médico y fecha
        para el rango de fechas seleccionado y muestra los resultados en el GridView.*/
        protected void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            DataTable tabla = neg.getPacientesPorMedicoYFecha(fechaDesde, fechaHasta);

            if (tabla.Rows.Count == 0)
            {
                lblMensaje.Text = "No se registraron pacientes atendidos o asignados en ese rango de fechas.";
                lblMensaje.ForeColor = System.Drawing.Color.Red;
